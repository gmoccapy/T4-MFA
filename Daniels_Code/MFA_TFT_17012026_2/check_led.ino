...
if (shutdown_timer != 0) {
  ...
  if((Data.page == 0) || (Data.page == 1)){
    ...
    if(door == true){
      ...
      tft.fillRect(Icon_Pos_Door[0], Icon_Pos_Door[1], 50, 50, SYM_NA_COLOR);
    }
    ...
    if (battery == true){
      ...
      tft.fillRect(Icon_Pos_Battery[0], Icon_Pos_Battery[1], 50, 50, SYM_NA_COLOR);
    }
...
uint16_t oil_color = SYM_NA_COLOR;  // Default: nichts anzeigen
    ...
    if (oil_color != SYM_NA_COLOR) {
      ...
      tft.fillRect(Icon_Pos_Oil[0], Icon_Pos_Oil[1], 50, 50, SYM_NA_COLOR);
      oil_pressure = true;
    }
 }
    ...
    // coolant   // Logik umkehr wegen Auswertung LED
      if((i == 9) && (io_state == true)){
        ...
        coolant = true;
        tft.fillRect(Icon_Pos_Coolant[0], Icon_Pos_Coolant[1], 50, 50, SYM_NA_COLOR);
      }
    ...
    // brakepads (circuit normaly closed)
      if((i == 0) && (io_state == false)){
        brakepads = false;
         ...
         tft.fillRect(Icon_Pos_BrakePads[0], Icon_Pos_BrakePads[1], 50, 50, SYM_NA_COLOR);
         brakepads = true;
       }
...
//      }
    ...
    // washer fluid
      if((i == 3) && (io_state == true)){
        ...
        tft.fillRect(Icon_Pos_WasherFluid[0], Icon_Pos_WasherFluid[1], 50, 50, SYM_NA_COLOR);
      }
    ...
    // brakesystem 
      if((i == 2) && (io_state == true)){
        ...
        brakesystem = true;
        tft.fillRect(Icon_Pos_BrakeSystem[0], Icon_Pos_BrakeSystem[1], 50, 50, SYM_NA_COLOR);
      }
