...
//Serial.println("This is update values");
 ...
 case 1:
      ...
      if ( (motor_on == false) || (battery) ){ //    || (warnings)      
        // do nothing
      }
      else{
        ...
        switch(Data.mode){
          ...
          case START:  
            ...
            if (Data.km_start > 0 ){
              ...
              draw_dial(75, 108, temp, 1, C_dial_display_value, 24.0, F("ab"), F("Start"));
            break;
 ...
 //     #endif
    ...
    case 3:
      // Line 1 = 72  ()
      draw_value_cruise_control(70);
      draw_compass(105, 70);  //cruise control icon: 19, 70y-25
      draw_GPS_direction(70 + 109); // Zeile 8
      draw_GPS_speed(70 + 200);     // Zeile 9 198
...
/*
if (Data.km_start > 0) {
    temp = (Data.C_start / float(Data.km_start)) / 10.0;  // ml/km → l/100km
  } else {
    temp = 0.0;
  }
      draw_dial(75, 118, temp, 1,C_dial_display_value, 24.0, F("Ab"), F("Start")); 
  */
      // Line 5 = 337 (range)
      ...
      //draw_value_oil_lvl(404); // funktion nicht aktiv
