...
case 0:
  ...
  // This is the visible area
    ...
    case 2:      
      ...
      if(Data.mode == START){
        tft.drawString(F("ab Start"), 160, 448, FONT4);
      }
      else if (Data.mode == REFUEL){
...
//  draw_GPS_altitude(70+66);
//  draw_GPS_time(70 + 66);       // Zeile 7
//  draw_GPS_direction(70 + 132); // Zeile 8
//  draw_GPS_speed(70 + 198);     // Zeile 9
...
////      drawTime(337);
////      drawAverageVelocity(404);
////      tft.drawString(F("PERIOD"), 160, 451, FONT4);
      break;
