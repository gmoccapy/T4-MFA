...
// DEBUG : Check LED behavior
  ...
  if((petrol == true) && (Data.page == 0)){
   ...
   if ((petrol == false) && (Data.page == 0)){ //&& (temp_color == TFT_ORANGE) ){
   tft.drawXBitmap(Icon_Pos_Petrol[0], Icon_Pos_Petrol[1], sym_petrol, 50, 50, BACK_COLOR);
   }
...
void switch_page(void){
  Data.page += 1;
  if (Data.page > maxpage){  //DEBUG maxpage is set in variables
    Data.page = 0;
  }
  temp_page = Data.page;
