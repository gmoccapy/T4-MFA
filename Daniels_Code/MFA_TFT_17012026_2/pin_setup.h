...
#define GPS_BAUD 9600  // Standard GY-GPS6MV2

// set up can system
// Default for ESP32
#define CAN_RX		GPIO_NUM_21    // Green connector PIN 19
#define CAN_TX		GPIO_NUM_22    // Green connector PIN 20


//#define KLINE_RX_PIN  GPIO_NUM_26
//#define KLINE_TX_PIN  GPIO_NUM_27
//#define KLINE_TX_PIN    GPIO_NUM_13
...
// Door right PIN ; IN   Dieser Eingang wird aktuell zur Überwachung der orange Öl LED benötigt
//#define PIN_R_DOOR 4
// Door Sliding PIN ; IN
#define PIN_S_DOOR 5
// we do not use PIN 6 and 7
// Oil Pressure PIN ; IN
#define PIN_OIL_PRESSURE 8 
// Coolant PIN ; IN
...
// Oil Level PIN ; IN
//#define PIN_OIL_LEVEL 25  // LED Auswertung - 'Änderung nach Pin 4
#define PIN_OIL_LEVEL 4
// Oil Level PWM signal
#define PIN_OIL_PWM GPIO_NUM_19
