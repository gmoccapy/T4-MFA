...
#define LIGHT_GREEN       0xafd4

#ifdef SYM_NA_VISIBLE
#define SYM_NA_COLOR     0x2124// 0x39e7 
#else
#define SYM_NA_COLOR      BACK_COLOR
#endif
...
// Neue Variablen für Memory-Schalter
int currentMemory = 0;  // 0 oder 1, basierend auf Memory_Button_state
bool previousMemoryState = false;  // Zum Erkennen von Wechseln
int maxpage[2] = {1, 1};   // Memory 0: maxpage=1 (Pages 0,1);
...
#ifdef SYM_NA_VISIBLE
int Icon_Pos_Warn[2]      = {210, 220};       // position ersetzt Baattery Warn red
#else
...
bool Memory_Button_state = false;
